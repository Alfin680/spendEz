...
//     final url = Uri.parse(
//         "http://127.0.0.1:5000/category-spending-week?user_id=${widget.userId}&category=Fun"); // Replace "Fun" with the desired category
//     try {
...
//     final url = Uri.parse(
//         "http://127.0.0.1:5000/category-budget-spent?user_id=${widget.userId}&category=Fun"); // Replace "Fun" with the desired category
//     try {
//       final response = await http.get(url);
//       if (response.statusCode == 200) {
//         final data = json.decode(response.body);
...
class _FunScreenState extends State<FunScreen> {
  ...
  Future<void> _fetchSpendingData() async {
    final url = Uri.parse(
        "http://10.0.2.2:5000/category-spending-week?user_id=${widget.userId}&category=Fun"); // Replace "Fun" with the desired category
    try {
      final response = await http.get(url);
      if (response.statusCode == 200) {
        final data = json.decode(response.body);
  ...
  Future<void> _fetchBudgetSpent() async {
    final url = Uri.parse(
        "http://10.0.2.2:5000/category-budget-spent?user_id=${widget.userId}&category=Fun"); // Replace "Fun" with the desired category
    try {
      final response = await http.get(url);
      if (response.statusCode == 200) {
        final data = json.decode(response.body);
